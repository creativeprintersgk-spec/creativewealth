...
export const defaultGroups: Group[] = [
  ...
  { id: 'stcg_equity', name: 'STCG Listed Equity (20%)', parent: 'capital_gains', type: 'INCOME' },
  { id: 'ltcg_equity', name: 'LTCG Listed Equity (12.5%)', parent: 'capital_gains', type: 'INCOME' },
  { id: 'stcg_debt', name: 'STCG Debt/Other', parent: 'capital_gains', type: 'INCOME' },
  { id: 'ltcg_debt', name: 'LTCG Debt/Other', parent: 'capital_gains', type: 'INCOME' },
