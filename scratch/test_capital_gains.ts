...
function testCapitalGains() {
  ...
  const stcgResult = calculateCapitalGains(
    'stock1',
    'port1',
    '2024-01-20', // Sale date
    120,          // Sale price
    50,           // Quantity sold
    sampleTaxLots
  );
  ...
  const ltcgResult = calculateCapitalGains(
    'stock1',
    'port1',
    '2024-07-01', // Sale date (more than 365 days after purchase)
    200,          // Sale price
    100,          // Quantity sold
    sampleTaxLots
  );
  ...
  const fdResult = calculateCapitalGains(
    'fd1',
    'port1',
    '2024-03-01',
    110,          // Sale price
  ...
  const sale1 = calculateCapitalGains(
    'stock1',
    'port1',
    '2024-01-20',
    120,
  ...
  const sale2 = calculateCapitalGains(
    'stock1',
    'port1',
    '2024-02-01',
    130,
  ...
  const lossResult = calculateCapitalGains(
    'stock1',
    'port1',
    '2023-12-01', // Sale at lower price
  ...
  const mfResult = calculateCapitalGains(
    'mf1',
    'port1',
    '2024-01-01',
    12,          // Price increased from ₹10 to ₹12
    500,
    sampleTaxLots
  );
